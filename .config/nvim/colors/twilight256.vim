...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("TabLine","000000","b0b8c0","none")
    call <SID>X("TabLineFill","000000","","")
    call <SID>X("TabLineSel","000000","f0f0f0","")

    " highlight groups
    "call <SID>X("Cursor", "708090", "f0e68c", "")
    call <SID>X("CursorColumn", "", "2C323C", "")
    "CursorIM
    "Directory
    call <SID>X("DiffAdd", "D2EBBE", "437019", "")
    call <SID>X("DiffChange", "", "2B5B77", "")
    call <SID>X("DiffDelete", "40000A", "700009", "")
    call <SID>X("DiffText", "8fbfdc", "000000", "reverse")
    "ErrorMsg
    call <SID>X("VertSplit", "808080", "080808", "bold")
    call <SID>X("Folded", "a0a8b0", "384048", "")
    call <SID>X("FoldColumn", "", "000000", "")
    "call <SID>X("IncSearch", "708090", "f0e68c", "")
    call <SID>X("LineNr", "AAAAAA", "", "")
    call <SID>X("CursorLineNr", "EEEEEE", "", "")
    call <SID>X("SignColumn", "CCCCCC", "none", "")
    "call <SID>X("ModeMsg", "D4D4D4", "", "")
    "call <SID>X("MoreMsg", "2e8b57", "", "")
    call <SID>X("NonText", "606060", "", "bold")
    call <SID>X("Pmenu", "FFFFFF", "333333", "")
    call <SID>X("PmenuSel", "101010", "eeeeee", "bold")
    "call <SID>X("Question", "00ff7f", "", "")
    call <SID>X("Search", "", "AFC4DB", "")
    "call <SID>X("SpecialKey", "9acd32", "", "")
    "call <SID>X("StatusLine", "c2bfa5", "000000", "reverse")
    "call <SID>X("StatusLineNC", "c2bfa5", "7f7f7f", "reverse")
    "call <SID>X("Title", "cd5c5c", "", "")
    call <SID>X("Visual", "", "585858", "")
    call <SID>X("MatchParen", "", "AFC4DB", "bold")
    "VisualNOS
    ...
    "Error
    call <SID>X("Todo", "NONE", "NONE", "bold")
